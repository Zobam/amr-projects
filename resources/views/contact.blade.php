        ...
        <div class="">
            ...
            <form name="contactForm" class="form" action="/contact" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <label><input type="radio" name="gov_rep" value=1 class="gov-rep" {{ old('gov_rep') == 1? 'checked':'' }}> Yes</label>
                    <label style="display: inline-block; margin-left: .5rem"><input type="radio" name="gov_rep" value=0 class="gov-rep" {{ old('gov_rep') == 0? 'checked':'' }}> No</label>
                ...
                <div class="d-flex">
                    <div class=" form-group" style="margin-right: 1rem; position: relative">
                        ...
                        <input type="text" name="country_code" id="country_code" value="{{ old('country_code') }}" onchange="checkFormValidity('contact_no', 'code')">
                    ...
                    <div class="flex-grow-1 form-group">
                        ...
                        <input type="tel" name="contact_no" id="contact_no" value="{{ old('contact_no') }}" onchange="checkFormValidity('contact_no', 'tel')">
